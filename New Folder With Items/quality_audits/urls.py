...
urlpatterns = [
    ...
    # QIA (Quality Improvement Actions) URLs
    path('qia/', views.QIADashboardView.as_view(), name='qia_dashboard'),
    path('qia/list/', views.QIAListView.as_view(), name='qia_list'),
    path('qia/create/', views.QIACreateView.as_view(), name='qia_create'),
    path('qia/<int:pk>/', views.QIADetailView.as_view(), name='qia_detail'),
    path('qia/<int:pk>/update/', views.QIAUpdateView.as_view(), name='qia_update'),
    path('qia/<int:qia_pk>/progress/', views.QIAProgressUpdateView.as_view(), name='qia_progress'),
    path('qia/<int:qia_pk>/review/', views.QIAVerifyView.as_view(), name='qia_review'),
    path('qia/<int:pk>/delete/', views.QIADeleteView.as_view(), name='qia_delete'),
    path('qia/evidence-pack/', views.generate_qia_evidence_pack, name='qia_evidence_pack'),
]
