...
with transaction.atomic():
    ...
    print(f'  ✅ Created {users_created} management staff with {shifts_created} shifts')
    ...
    for unit_name, unit_data in UNIT_STAFFING.items():
        ...
        print(f'  ✅ {unit_name}: {unit_users} staff, {unit_shifts} shifts')

print(f'\n' + '=' * 80)
print(f'✅ ORCHARD GROVE IMPORT COMPLETE')
print(f'=' * 80)
...
print('\n⏭️  Next: Run replication script to copy to other 3 homes')
