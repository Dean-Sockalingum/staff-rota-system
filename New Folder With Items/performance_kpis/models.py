...
class KPIAlert(models.Model):
    """
    Alert triggered when KPI breaches threshold.
    Supports automatic monitoring and email notifications.
    """
    SEVERITY_CHOICES = [
        ('INFO', 'Information'),
        ('WARNING', 'Warning'),
    ...
    MODULE_CHOICES = [
        ('MODULE_1', 'Module 1: Quality Audits'),
        ('MODULE_2', 'Module 2: Incident & Safety'),
        ('MODULE_3', 'Module 3: Experience & Feedback'),
        ('MODULE_4', 'Module 4: Training & Competency'),
        ('MODULE_5', 'Module 5: Policies & Procedures'),
        ('MODULE_6', 'Module 6: Risk Management'),
        ('MODULE_7', 'Module 7: Dashboard'),
    ]
    ...
    assigned_to = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='assigned_kpi_alerts'
    )
...
class AlertThreshold(models.Model):
    ...
    Define warning and critical thresholds for automatic monitoring.
    """
    COMPARISON_CHOICES = [
        ('GT', 'Greater Than'),
        ('LT', 'Less Than'),
    ...
    module = models.CharField(max_length=20, choices=KPIAlert.MODULE_CHOICES)
    ...
    comparison_operator = models.CharField(max_length=3, choices=COMPARISON_CHOICES)
    
    # Email notifications
    send_email_notifications = models.BooleanField(default=True)
    notification_recipients = models.ManyToManyField(
        settings.AUTH_USER_MODEL,
        related_name='alert_threshold_recipients',
        blank=True
    )
