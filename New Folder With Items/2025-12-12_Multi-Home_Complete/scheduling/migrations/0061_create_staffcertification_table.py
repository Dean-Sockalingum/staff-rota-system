# Generated manually on 2026-01-19 10:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['staff_member', 'expiry_date'], name='scheduling_staff_m_c7b21e_idx'),
        ),
        migrations.AddIndex(
            model_name='staffcertification',
            index=models.Index(fields=['certification_type', 'status'], name='scheduling_certif_a3d9f2_idx'),
        ),
        migrations.AddIndex(
            model_name='staffcertification',
            index=models.Index(fields=['expiry_date', 'status'], name='scheduling_expiry_b8e4c1_idx'),
        ),
    ]
