...
from .views_pattern_overview import (
    pattern_overview,
    toggle_vacancy_status,
    update_shift_unit
)
...
urlpatterns = [
    ...
    path('pattern-overview/', pattern_overview, name='pattern_overview'),
    path('api/toggle-vacancy/', toggle_vacancy_status, name='toggle_vacancy_status'),
    path('api/update-shift-unit/', update_shift_unit, name='update_shift_unit'),
