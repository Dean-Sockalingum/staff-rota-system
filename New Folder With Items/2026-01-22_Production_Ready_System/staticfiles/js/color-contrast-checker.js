...
const ColorContrastChecker = {
    ...
    testDesignSystemColors() {
        ...
        const colorTests = [
            ...
            { fg: '#4CAF50', bg: '#FFFFFF', name: 'Success-500 on White' },
            { fg: '#FFFFFF', bg: '#4CAF50', name: 'White on Success-500' },
            { fg: '#FFFFFF', bg: '#388E3C', name: 'White on Success-700' },
            
            // Warning combinations
            { fg: '#FFC107', bg: '#FFFFFF', name: 'Warning-500 on White' },
            { fg: '#FFFFFF', bg: '#FFC107', name: 'White on Warning-500' },
            { fg: '#000000', bg: '#FFC107', name: 'Black on Warning-500' },
            
            // Danger combinations
            { fg: '#F44336', bg: '#FFFFFF', name: 'Danger-500 on White' },
            { fg: '#FFFFFF', bg: '#F44336', name: 'White on Danger-500' },
            ...
            { fg: '#7B8794', bg: '#FFFFFF', name: 'Neutral-500 on White' },
