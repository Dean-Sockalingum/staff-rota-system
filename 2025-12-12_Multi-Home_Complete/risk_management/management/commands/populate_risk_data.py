...
class Command(BaseCommand):
    ...
    def create_risks(self, categories):
        ...
        # Medication risks
        medication_cat = RiskCategory.objects.get(code='CLIN-MED')
        ...
        # Infection control
        infection_cat = RiskCategory.objects.get(code='CLIN-IPC')
        ...
        # Falls prevention
        falls_cat = RiskCategory.objects.get(code='CLIN-FALL')
        ...
        # Staffing
        staffing_cat = RiskCategory.objects.get(code='OPER-STAFF')
        ...
        regulatory_cat = RiskCategory.objects.get(code='REG')
        ...
        # Building safety
        building_cat = RiskCategory.objects.get(code='OPER-BUILD')
        ...
        # Nutrition
        nutrition_cat = RiskCategory.objects.get(code='CLIN-NUT')
        ...
        # Financial
        financial_cat = RiskCategory.objects.get(code='FIN')
